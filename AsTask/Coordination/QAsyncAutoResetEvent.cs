...
namespace HardDev.AsTask.Coordination
{
    ...
    /// </summary>
    public sealed class QAsyncAutoResetEvent
    {
        /// <summary>
        ...
        public QAsyncAutoResetEvent(bool set, IAsyncWaitQueue<object> queue)
        {
        ...
        /// </summary>
        /// <param name="set">Whether the auto-reset event is initially set or unset.</param>
        public QAsyncAutoResetEvent(bool set)
            : this(set, null)
        {
        }
        ...
        /// </summary>
        public int Id => QIdManager<QAsyncAutoResetEvent>.GetId(ref _id);
