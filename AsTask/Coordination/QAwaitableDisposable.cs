...
namespace HardDev.AsTask.Coordination
{
    ...
    public struct QAwaitableDisposable<T> where T : IDisposable
    {
        /// <summary>
        /// The underlying task.
        /// </summary>
        ...
        public QAwaitableDisposable(Task<T> task)
        {
        ...
        public static implicit operator Task<T>(QAwaitableDisposable<T> source)
        {
