...
namespace HardDev.AsTask.Coordination
{
    ...
    /// </summary>
    public sealed class QAsyncMonitor
    {
        /// <summary>
        /// The lock.
        /// </summary>
        private readonly QAsyncLock _asyncLock;

        /// <summary>
        /// The condition variable.
        /// </summary>
        private readonly QAsyncConditionVariable _conditionVariable;
        ...
        public QAsyncMonitor(IAsyncWaitQueue<IDisposable> lockQueue, IAsyncWaitQueue<object> conditionVariableQueue)
        {
            _asyncLock = new QAsyncLock(lockQueue);
            _conditionVariable = new QAsyncConditionVariable(_asyncLock, conditionVariableQueue);
        }

        /// <summary>
        /// Constructs a new monitor.
        /// </summary>
        public QAsyncMonitor()
            : this(null, null)
        {
        }
        ...
        public QAwaitableDisposable<IDisposable> EnterAsync(CancellationToken cancellationToken)
        {
        ...
        /// </summary>
        /// <returns>A disposable that leaves the monitor when disposed.</returns>
        public QAwaitableDisposable<IDisposable> EnterAsync()
        {
