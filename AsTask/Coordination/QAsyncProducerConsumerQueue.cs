...
namespace HardDev.AsTask.Coordination
{
    ...
    public sealed class QAsyncProducerConsumerQueue<T>
    {
        /// <summary>
        ...
        public QAsyncProducerConsumerQueue(IEnumerable<T> collection, int maxCount = int.MaxValue)
        {
            if (maxCount <= 0)
        ...
        public QAsyncProducerConsumerQueue(int maxCount)
            : this(null, maxCount)
        {
        }
        ...
        /// </summary>
        public QAsyncProducerConsumerQueue()
            : this(null)
        {
        }
        ...
        /// <summary>
        /// Remove from the queue an item from the producer/consumer queue. Throws <see cref="InvalidOperationException"/> if the producer/consumer queue has completed adding and is empty.
        /// </summary>
        /// <param name="cancellationToken">A cancellation token that can be used to abort the dequeue operation.</param>
        ...
        /// <summary>
        /// Remove from the queue an item from the producer/consumer queue. Returns the dequeued item. Throws <see cref="InvalidOperationException"/> if the producer/consumer queue has completed adding and is empty.
        /// </summary>
        /// <returns>The dequeued item.</returns>
        /// <exception cref="InvalidOperationException">The producer/consumer queue has been marked complete for adding and is empty.</exception>
        ...
        /// <summary>
        /// Remove from the queue an item from the producer/consumer queue. Returns the dequeued item. This method may block the calling thread. Throws <see cref="InvalidOperationException"/> if the producer/consumer queue has completed adding and is empty.
        /// </summary>
        /// <param name="cancellationToken">A cancellation token that can be used to abort the dequeue operation.</param>
        /// <returns>The dequeued item.</returns>
        /// <exception cref="InvalidOperationException">The producer/consumer queue has been marked complete for adding and is empty.</exception>
