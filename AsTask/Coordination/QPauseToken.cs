...
namespace HardDev.AsTask.Coordination
{
    ...
    /// </summary>
    public sealed class QPauseTokenSource
    {
        /// <summary>
        ...
        /// </summary>
        private readonly QAsyncManualResetEvent _mre = new QAsyncManualResetEvent(true);
        ...
        /// </summary>
        public QPauseToken Token => new QPauseToken(_mre);
    }

    /// <summary>
    /// A type that allows an operation to be cooperatively paused.
    /// </summary>
    public struct QPauseToken
    {
        /// <summary>
        ...
        /// </summary>
        private readonly QAsyncManualResetEvent _mre;

        internal QPauseToken(QAsyncManualResetEvent mre)
        {
            _mre = mre;
        }
        ...
        {
            if (_mre == null)
                return QTaskConstants.Completed;
