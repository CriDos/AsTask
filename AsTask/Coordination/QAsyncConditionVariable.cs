...
namespace HardDev.AsTask.Coordination
{
    ...
    /// </summary>
    public sealed class QAsyncConditionVariable
    {
        /// <summary>
        ...
        public QAsyncConditionVariable(QAsyncLock asyncLock, IAsyncWaitQueue<object> queue = null)
        {
        ...
        /// </summary>
        public int Id => QIdManager<QAsyncConditionVariable>.GetId(ref _id);
        ...
        public Task WaitAsync(CancellationToken cancellationToken)
        {
            lock (_mutex)
            {
                ...
                Task task = _queue.Enqueue(_mutex, cancellationToken);
        ...
        private static async Task WaitAndRetakeLockAsync(Task task, QAsyncLock asyncLock)
        {
            try
            {
