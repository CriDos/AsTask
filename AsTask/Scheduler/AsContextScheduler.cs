...
namespace HardDev.AsTaskLib.Scheduler
{
    ...
    /// </summary>
    public sealed class AsContextScheduler : TaskScheduler
    {
        /// <summary>
        ...
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="T:HardDev.AsTask.Context.AsContext.AsContextScheduler" /> class.
        /// </summary>
        /// <param name="context">The async context for this task scheduler. May not be <c>null</c>.</param>
        public AsContextScheduler(AsContext context)
        {
            _context = context;
        }
        ...
        {
            return AsContext.Current == _context && TryExecuteTask(task);
        }
