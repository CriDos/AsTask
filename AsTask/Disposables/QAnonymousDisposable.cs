...
namespace HardDev.AsTask.Disposables
{
    ...
    /// </summary>
    public sealed class QAnonymousDisposable : QSingleDisposable<Action>
    {
        /// <inheritdoc />
        /// <summary>
        ...
        public QAnonymousDisposable(Action dispose)
        {
            CreatesDisposableContext(dispose);
        }
        ...
        public static QAnonymousDisposable Create(Action dispose) => new QAnonymousDisposable(dispose);
    }
}