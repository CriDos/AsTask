...
namespace HardDev.AsTask.TaskHelpers
{
    ...
    /// </summary>
    public static class QTaskExtensions
    {
        ...
        {
            using (var cancelTaskSource = new QCancellationTokenTaskSource<object>(cancellationToken))
        ...
        {
            using (var cancelTaskSource = new QCancellationTokenTaskSource<TResult>(cancellationToken))
