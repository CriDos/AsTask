...
namespace HardDev.AsTask.Deque
{
    ...
    public sealed class QDeque<T> : IList<T>, IReadOnlyList<T>, IList
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QDeque{T}"/> class with the specified capacity.
        /// </summary>
        /// <param name="capacity">The initial capacity. Must be greater than <c>0</c>.</param>
        public QDeque(int capacity)
        {
            if (capacity < 0)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QDeque{T}"/> class with the elements from the specified collection.
        /// </summary>
        /// <param name="collection">The collection. May not be <c>null</c>.</param>
        public QDeque(IEnumerable<T> collection)
        {
            if (collection == null)
                throw new ArgumentNullException(nameof(collection));

            var source = QCollectionHelpers.ReifyCollection(collection);
        ...
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="T:HardDev.AsTask.Deque.QDeque`1" /> class.
        /// </summary>
        public QDeque()
